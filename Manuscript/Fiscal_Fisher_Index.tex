...
\begin{equation*}
	...
	\label{DI}
\end{equation*}
Here, $M^d_t$ is the level of the Divisia quantity index, $x^n_{t}$ is the nominal value of asset $n$, 
\begin{equation*}
	s_{n,t}  = \frac{\eta^n_{t}x^n_{t}}{\boldsymbol \eta_t' \mathbf{x}_t}
\end{equation*}
corresponds to the weight on the marginal change in financial asset $n$, and $\mathbf{x}_t$ and $\boldsymbol \eta_t$ are $N \times 1$ vectors of nominal quantities and user costs, respectively.
