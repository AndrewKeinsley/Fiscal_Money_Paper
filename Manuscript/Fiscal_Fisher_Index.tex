...
\title{A New Measurement of Fiscal Debt and What it Tells Us About Fiscal Capacity}
%\thanks{
...
\begin{abstract}
\noindent In light of growing debates around fiscal capacity in the US, I develop a measurement of the true economic value of Treasury debt.
First, I show that the underlying securities that make up the debt cannot be considered perfect substitutes as simple-sum aggregates implicitly assume.
...
With this, I demonstrate how the economic value of these securities---above and beyond basic accounting---influences fiscal capacity in the US.

%monetary services channel to the fiscal theory of the price level.
\end{abstract}
\vspace{2em}

\noindent{Keywords}: Fiscal Capacity, Index Number Theory, Fiscal Debt, Aggregation
\newpage
\setcounter{page}{1}
...
Lastly, I show that the value of these monetary services directly increases the government's fiscal capacity.
