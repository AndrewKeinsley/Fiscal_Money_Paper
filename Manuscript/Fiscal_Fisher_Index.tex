...
\noindent{Keywords}: Treasury Debt, Aggregation, Market Depth, Fiscal Capacity, Index Number Theory
\newpage
\setcounter{page}{1}
...
This paper introduces index number theory to the fiscal debt discussion, continuing the move from simple accounting to a measure of the full economic value of fiscal debt.
...
Next, I motivate the use of an index number to account for this imperfect subsitutability; deriving the user cost for fiscal debt securities and creating a Fisher ideal quantity index that tracks the true aggregate.
...
Together, these results reveal that our standard view of fiscal debt, and our policy/discussion surrounding it, is flawed.
...
Regressing relative yields to maturity (YTM) of the securities against their relative liquidities, coupons, etc.; I find that bills benefit from a liquidity premium even relative to defacto zero-coupon notes with the same time to maturity.\footnote{
...
With this I construct a quantity index that tracks outstanding fiscal debt in the United States since 1977 and use it to derive the growth rate of the monetary services provided by this stock of fiscally-provided assets. 
...
At first glance, this could lead many to think that this new metric means there is {\em less} fiscal capacity, but the monetary services add depth to the market and demand for the debt, increasing the government's ability to borrow.
...
The view of market depth derived here show a large, sustained growth in monetary services during the former period, and a sharp decrease in monetary services during the latter period.
...
\label{subsec:MktSeg}
Fiscal debt is ubiquitously measured as the sum of outstanding principal values, but simple-sum aggregates come with an assumption that the underlying assets are perfect substitutes. 
